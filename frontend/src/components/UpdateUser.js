...
const Updateuser = () => {
    ...
    const [age, emailchange] = useState('');
    ...
    useEffect(() => {
        if(userobj){
            idchange(userobj.id);
            namechange(userobj.username);
            emailchange(userobj.age);
                    ...
                    <div className="card-body" style={{ textAlign: 'left' }}>
                        <div className="row">
                            ...
                            <div className="col-lg-12">
                                <div className="form-group">
                                    <label>Email</label>
                                    <input value={age || ''} onChange={e => emailchange(e.target.value)} className="form-control"></input>
                                </div>
                            </div>
                            {/* <div className="col-lg-12">
                                <div className="form-group">
